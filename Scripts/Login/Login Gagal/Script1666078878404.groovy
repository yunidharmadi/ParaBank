...
String username = ExcelKeywords.getCellValueByAddress(sheet, "A3")
String password = ExcelKeywords.getCellValueByAddress(sheet, "B3")
...
WebUI.verifyElementVisible(findTestObject('Object Repository/Login/p_Login Gagal'))