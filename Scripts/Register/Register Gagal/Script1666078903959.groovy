...
String firstName = ExcelKeywords.getCellValueByAddress(sheet, "A3")
String lastName = ExcelKeywords.getCellValueByAddress(sheet, "B3")
String address = ExcelKeywords.getCellValueByAddress(sheet, "C3")
String city = ExcelKeywords.getCellValueByAddress(sheet, "D3")
String state = ExcelKeywords.getCellValueByAddress(sheet, "E3")
String zipCode = ExcelKeywords.getCellValueByAddress(sheet, "F3")
String phone = ExcelKeywords.getCellValueByAddress(sheet, "G3")
String SSN = ExcelKeywords.getCellValueByAddress(sheet, "H3")
String username = ExcelKeywords.getCellValueByAddress(sheet, "I3")
String password = ExcelKeywords.getCellValueByAddress(sheet, "J3")
String confirmPassword = ExcelKeywords.getCellValueByAddress(sheet, "K3")
...
WebUI.verifyElementVisible(findTestObject('Object Repository/Register/p_Register Gagal'))
